...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function flash($type, $body)
        {
                        return \Illuminate\Http\RedirectResponse::flash($type, $body);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\RedirectResponse::success($body);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\RedirectResponse::error($body);
        }
